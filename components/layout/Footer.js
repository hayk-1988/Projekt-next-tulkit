        ...
        <div className={s['footer']}>
            ...
            <div className={s['footer-main']}>
                ...
                <div className={`${s['footer-main__col']} ${s['footer-main__col-logo']}`}>
                    ...
                    <div>
                        <img src="https://wp.alithemes.com/html/nest/demo/assets/imgs/theme/app-store.jpg"
                             alt="app store"/>
                        <img src="https://wp.alithemes.com/html/nest/demo/assets/imgs/theme/google-play.jpg"
                             alt="google play"/>
                    </div>
                    <p>Secured Payment Gateways</p>
                    <img src="https://wp.alithemes.com/html/nest/demo/assets/imgs/theme/payment-method.png"
                         alt="master card"/>
                </div>
