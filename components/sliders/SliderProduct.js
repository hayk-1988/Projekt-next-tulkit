        ...
        <div className="product-card sp">
            ...
            <div className="action-bar">
                <button className="btn-svg">
                    <svg width="11" height="11" viewBox="0 0 25 25" fill="none"
            ...
            <div className="product-description">
                ...
                <p className="product-card__manufacturer-bar">By <a
                    className="manufacturer" href="1-Project/day-12-Reactov-shoppi-ejery/src/sliders/SliderProduct#">NestFood</a>
                </p>
